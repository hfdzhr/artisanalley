        ...
        >
          ...
          >
            ...
            <div class="flex justify-between">
              ...
              <div class="">
                <p class="mb-1 text-lg font-bold">Rp. {{ totalPrice + (getAllCart.length * 10000) }}</p>
              </div>
            </div>
            <button
...
export default {
  computed: {
    ...
    totalPrice() {
      const total = this.getAllCart.reduce((accumulator, object) => {
        return accumulator + object.regular_price;
      }, 0);
      return total;
    },
  },
